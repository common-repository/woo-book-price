<div class="wrap op-conten-wrap">
    <h1><?php echo __( 'New Price Books', 'woo-book-price' ); ?></h1>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <form class="form-horizontal" id="book-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="book_title" name="title" placeholder="Book Title">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="status">
                                    <option value="1"><?php echo __( 'Publish', 'woo-book-price' ); ?></option>
                                    <option value="2" selected><?php echo __( 'Pending', 'woo-book-price' ); ?></option>
...
<script type="text/javascript">
    ...
    (function($) {
        ...
        var table = $('#op-transfer-grid').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: "<?php echo admin_url( 'admin-ajax.php?book_id=0' ); ?>",
                type: 'post',
